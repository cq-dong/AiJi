  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      <button
        ...
        className="flex items-center gap-2.5 rounded-card bg-priS p-3 text-left transition duration-base ease-out active:scale-[0.99] focus-visible:ring-2 focus-visible:ring-pri/40 focus-visible:ring-offset-2 focus-visible:ring-offset-card"
      >
